...
for Test 4 (Apollo 11), Test 5 (World War II), and Test 6 (French Revolution).
...
ARTICLE_TITLE = "American Civil War"
OUTPUT_PATH = "test-7-data/american_civil_war_wikipedia.txt"
TARGET_WORDS = 5000
...
def clean_text(raw: str) -> str:
    ...
    # Turn section headers "== See also ==" into plain sentences-ending markers
